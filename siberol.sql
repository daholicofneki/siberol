...
INSERT INTO `account` VALUES ('user1', 'user', 'Neki', 'Wartawan');
INSERT INTO `account` VALUES ('user2', 'user', 'Nurvina', 'Wartawan');
...
CREATE TABLE `berita` (
  ...
  `nama_wartawan` varchar(32) DEFAULT NULL,
